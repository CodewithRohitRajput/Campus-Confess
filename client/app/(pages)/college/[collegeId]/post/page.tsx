...
export default function Post(){
    ...
    useEffect(()=>{
        const getCollegeName = async () => {
            const res = await fetch(`${process.env.backend}/college/getname/${collegeId}`);
    ...
    const handleSubmit = async() =>{
        ...
        const res = await fetch(`${process.env.backend}/confession/${collegeId}/post` , {method : "POST" , credentials : "include", 
